...
The menu bar uses a simplified, open-outline monochrome M drawn on an 18-point grid and rendered from SVG at 1× and 2× resolution, automatically tinted by AppKit, with service status in its tooltip and menu.
