...
MINDROOM_REPLAY_STATE_METADATA_KEY = "mindroom_replay_state"
MINDROOM_REPLAY_STATE_INTERRUPTED = "interrupted"
MINDROOM_RESTART_RECOVERY_PENDING_METADATA_KEY = "mindroom_restart_recovery_pending"
