...
from mindroom.constants import RuntimePaths, resolve_config_relative_path, validate_runtime_control_path
...
def _resolve_plugin_root(plugin_path: str, runtime_paths: RuntimePaths) -> Path:
    ...
    if parsed_python_spec is None:
        try:
            return validate_runtime_control_path(plugin_path, runtime_paths, field_name="Plugin path")
