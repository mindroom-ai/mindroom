...
class MatrixApiTools(Toolkit):
    ...
    @staticmethod
    async def _redaction_cache_write_error(
        context: ToolRuntimeContext,
        *,
        room_id: str,
        event_id: str,
    ) -> str | None:
        """Return why redaction bookkeeping cannot safely proceed."""
        try:
    ...
    async def _redact(  # noqa: PLR0911
        ...
        *,
        ...
        thread_resolution_error = await self._redaction_cache_write_error(
            context,
            room_id=room_id,
