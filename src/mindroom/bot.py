...
class AgentBot:
    ...
    _live_invite_reconciliation_running: bool
    ...
    def _schedule_live_invite_reconciliation(self) -> None:
        ...
        if self.client is None or self._sync_shutting_down:
            return
        self._live_invite_reconciliation_pending = True
        if self._live_invite_reconciliation_running:
            return
        self._live_invite_reconciliation_running = True
    ...
    async def _reconcile_live_invites_when_safe(self) -> None:
        """Coalesce policy reconciliation outside partially applied responses."""
        try:
            while self._live_invite_reconciliation_pending:
