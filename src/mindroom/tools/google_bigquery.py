...
@register_tool_with_metadata(
    ...
    config_fields=[
        ...
        ConfigField(
            ...
            required=False,
            default=None,
            description="Deprecated alias for List Tables. Preserved for stored config compatibility.",
        ),
        ConfigField(
            ...
            required=False,
            default=None,
            description="Deprecated alias for Describe Table. Preserved for stored config compatibility.",
        ),
        ConfigField(
            ...
            required=False,
            default=None,
            description="Deprecated alias for Run SQL Query. Preserved for stored config compatibility.",
        ),
        ConfigField(
            name="all",
            label="All",
