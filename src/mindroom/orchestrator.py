...
from .orchestration.rooms import (
    ...
    warn_about_foreign_homeserver_authorities,
)
...
class _MultiAgentOrchestrator:
    ...
    async def initialize(self) -> None:
        ...
        self.config = config
        warn_about_foreign_homeserver_authorities(config, self.runtime_paths)
    ...
    async def _load_initial_config(self, new_config: Config) -> bool:
        ...
        self.config = new_config
        warn_about_foreign_homeserver_authorities(new_config, self.runtime_paths)
