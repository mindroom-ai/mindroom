...
from mindroom.workers.runtime import lease_primary_worker_manager, primary_worker_backend_available
...
@contextmanager
def _worker_manager_lease(request: Request) -> Iterator[WorkerManager]:
