...
from mindroom.tool_system.events import BackgroundWaitChunk, format_tool_completed_event, format_tool_started_event
...
def extract_stream_text(event: AIStreamChunk, tool_state: ToolStreamState) -> str | None:
    ...
    if isinstance(event, str):
        return event
    if isinstance(event, BackgroundWaitChunk):
