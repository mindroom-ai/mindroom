...
_INCREMENTAL_THREAD_REVALIDATION_REASON_SET = frozenset(_INCREMENTAL_THREAD_REVALIDATION_REASONS)
...
def is_incremental_thread_revalidation_reason(reason: str | None) -> bool:
    ...
    return reason in _INCREMENTAL_THREAD_REVALIDATION_REASON_SET
