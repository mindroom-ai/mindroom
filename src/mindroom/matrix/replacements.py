...
def ordered_replacements(
    ...
    *,
    ...
    rooms = {original.get("room_id")} if "room_id" in original else set()
    if (
    ...
    def valid(candidate: dict[str, Any]) -> bool:
        ...
        candidate_rooms = {*rooms, candidate.get("room_id")} if "room_id" in candidate else rooms
        return (
