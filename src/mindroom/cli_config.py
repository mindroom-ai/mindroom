...
def _full_template(provider_preset: ProviderPreset) -> str:
    ...
    default_provider, default_model_id = _DEFAULT_MODEL_PRESETS[provider_preset]
    ...
    config_data = {
        ...
        "authorization": {
            ...
            "global_users": [OWNER_MATRIX_USER_ID_PLACEHOLDER],
...
"""
    return f"{header}{yaml.safe_dump(config_data, sort_keys=False)}"
