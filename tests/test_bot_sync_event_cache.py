...
class TestThreadingBehavior(ThreadingBehaviorTestBase):
    ...
    @pytest.mark.asyncio
    async def test_limited_restored_first_sync_rewinds_live_cursor(self, bot: AgentBot) -> None:
    ...
    async def test_live_redaction_failure_does_not_rewind_raw_sync_position(
        ...
        bot._sync_cache_trust.checkpoint = SyncCheckpoint("s_before_redaction")
