...
def test_strip_enrichment_from_session_storage_updates_agent_and_team_runs() -> None:
    """Stored Agno session history should be scrubbed for both agent and team runs."""
    enriched = (
        "Question\n\n"
        "<mindroom_message_context>\n"
    ...
    team_message = session.runs[1].messages[0]
