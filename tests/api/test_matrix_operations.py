...
class TestMatrixOperations:
    ...
    @pytest.mark.asyncio
    async def test_get_all_agents_rooms(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
    ...
    @pytest.mark.asyncio
    async def test_get_specific_agent_rooms(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
    ...
    @pytest.mark.asyncio
    async def test_get_agent_rooms_not_found(self, test_client: TestClient):
    ...
    @pytest.mark.asyncio
    async def test_leave_room(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
        """Test leaving a room."""
        with (
            patch("mindroom.api.matrix_operations.create_agent_user", return_value=mock_agent_user),
            patch("mindroom.api.matrix_operations.login_agent_user", return_value=mock_matrix_client),
    ...
    @pytest.mark.asyncio
    async def test_leave_room_failure(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
    ...
    @pytest.mark.asyncio
    async def test_leave_room_agent_not_found(self, test_client: TestClient):
    ...
    @pytest.mark.asyncio
    async def test_leave_rooms_bulk(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
    ...
    @pytest.mark.asyncio
    async def test_leave_rooms_bulk_partial_failure(self, test_client: TestClient, mock_agent_user, mock_matrix_client):
...
class TestMatrixMockOperations:
    ...
    def test_mock_get_all_agents_rooms(self, test_client: TestClient):
    ...
    def test_mock_get_specific_agent_rooms(self, test_client: TestClient):
    ...
    def test_mock_leave_room(self, test_client: TestClient):
    ...
    def test_mock_leave_rooms_bulk(self, test_client: TestClient):
...
class TestMatrixOperationsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_matrix_client_error_handling(self, test_client: TestClient):
        """Test error handling when Matrix client fails."""
        with patch(
            "mindroom.api.matrix_operations.create_agent_user",
    ...
    @pytest.mark.asyncio
    async def test_matrix_login_error_handling(self, test_client: TestClient, mock_agent_user):
        """Test error handling when Matrix login fails."""
        with (
            patch("mindroom.api.matrix_operations.create_agent_user", return_value=mock_agent_user),
            patch(
                "mindroom.api.matrix_operations.login_agent_user",
                side_effect=ValueError("Login failed"),
            ),
        ):
            response = test_client.get("/api/matrix/agents/rooms")
            ...
            assert response.status_code == 200
            data = response.json()
            assert data["agents"] == []  # Empty list on failure