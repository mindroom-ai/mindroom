...
def test_workspace_mode_accepts_symlinks_that_stay_inside_workspace(tmp_path: Path) -> None:
    ...
    authorized = resolve_agent_file("alias.txt", workspace_root=workspace, file_access="workspace", field_name="attachment")
...
def test_unrestricted_mode_resolves_relative_paths_against_workspace(tmp_path: Path) -> None:
    ...
    authorized = resolve_agent_file("a.txt", workspace_root=workspace, file_access="unrestricted", field_name="attachment")
...
def test_unrestricted_mode_expands_home(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    authorized = resolve_agent_file("~/notes.txt", workspace_root=None, file_access="unrestricted", field_name="attachment")
