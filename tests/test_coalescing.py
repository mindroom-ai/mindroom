...
@pytest.mark.asyncio
async def test_upload_grace_barrier_does_not_wait_for_later_unresolved_reservation() -> None:
    """A bypass after upload-grace text must not wait for later unresolved ingress."""
    batches: list[CoalescedBatch] = []
