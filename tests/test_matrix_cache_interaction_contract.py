...
@pytest.mark.asyncio
async def test_recovered_limited_sync_certifies_after_local_cache_write(
    event_cache: ConversationEventCache,
) -> None:
    """The cache seam should preserve nio's recovered outcome and certify local durability."""
