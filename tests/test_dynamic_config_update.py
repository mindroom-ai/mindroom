...
class TestDynamicConfigUpdate:
    ...
    @pytest.mark.asyncio
    async def test_mindroom_user_change_updates_user_account(self) -> None:
        """Changing mindroom_user should refresh the internal user account and room memberships."""
        initial_config = Config(
            agents={
                "general": {
                    "display_name": "GeneralAgent",
