...
class TestBotScheduleCommands:
    ...
    async def test_command_response_uses_provided_stable_target(
        ...
        await mock_agent_bot._command_turn_executor.execute(
            room,
            event,
            "@user:server",
            command,
...
class TestCommandHandling:
    ...
    async def test_router_agent_handles_commands(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            bot._command_turn_executor.execute_if_owned.assert_called_once()
    ...
    async def test_router_command_blocked_by_reply_permissions(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            bot._command_turn_executor.execute_if_owned.assert_not_called()
...
class TestRouterSkipsSingleAgent:
    ...
    async def test_router_handles_schedule_command_in_single_agent_room(self) -> None:
        ...
        bot._command_turn_executor.execute_if_owned.assert_called_once()
        kwargs = bot._command_turn_executor.execute_if_owned.call_args.kwargs
