...
For details on skill eligibility gating (`openclaw.os`, `openclaw.requires`, `openclaw.always`) and command dispatch (`command-dispatch`, `command-tool`, `command-arg-mode`), see [Skills](skills.md).
