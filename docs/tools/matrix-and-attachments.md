...
MindRoom always uses provider temperature defaults for Vertex Claude, Claude Fable 5, and direct Google Gemini 3.6 Flash and Gemini 3.5 Flash-Lite summaries.
