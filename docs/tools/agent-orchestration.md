...
Unreadable sources, malformed records, missing attribution or timestamps, and detected compaction gaps produce partial coverage and corresponding bounded counters.
