...
| **Agent Orchestration** | oauth_connections, subagents, delegate, dynamic_workflow, report_publishing, claude_agent, config_manager, self_config, openclaw_compat | [→ agent-orchestration](agent-orchestration.md) |
