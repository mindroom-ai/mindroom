...
| **Agent Orchestration** | oauth_connections, subagents, delegate, dynamic_workflow, claude_agent, config_manager, openclaw_compat | [→ agent-orchestration](agent-orchestration.md) |
