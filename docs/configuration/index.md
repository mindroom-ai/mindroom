...
- `agents.<name>.context_files` inject workspace-relative file context into each freshly built agent instance, so edits affect the next reply/request in the normal runtime paths (see [Agents](agents.md))
