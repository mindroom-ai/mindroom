...
Use `action: require_approval` to pause matching tool calls and send a Matrix approval card.
Documented tool-owned no-op or fast-fail paths can bypass approval before policy evaluation.
