...
It enrolls only the requester of a newly created room. A failed initial join can retry after restart, but a requester who has already joined, left, or been banned is never force joined again.
