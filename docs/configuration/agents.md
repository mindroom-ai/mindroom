...
Reviews incur additional model usage; see [Automatic skill learning](../skills.md#automatic-skill-learning) for workspace ownership, minimal-mode deferral, retry behavior and rollback.
