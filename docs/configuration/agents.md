...
| `skill_learning` | object | disabled | Opt-in background Markdown skill learning; see [Automatic skill learning](../skills.md#automatic-skill-learning) for settings, scope and costs. Separate from Agno `learning_mode`. |
