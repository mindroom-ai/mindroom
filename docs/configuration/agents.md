...
The manual [`threads export`](../cli.md#threads-export) command skips directory-wide removal when it could export no room, because an empty result cannot be told apart from a failed one.
