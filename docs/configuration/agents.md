...
Use `inspect_subagent`, `wait_subagent`, `resume_subagent`, and `cancel_subagent` with that job ID to manage the current turn; see [Background jobs](../tools/agent-orchestration.md#background-jobs).
