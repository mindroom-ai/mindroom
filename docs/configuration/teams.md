...
An eligible individual agent that already replied can separately opt into [Adaptive Participation](agents.md#adaptive-participation) and answer an untagged turn after approval; this does not automatically form a team.
