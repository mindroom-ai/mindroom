...
4. Make `unavailable_notice_delivery_id` include the membership epoch, and derive the exact current generation inside `discard_unavailable_approval_continuation`'s transaction.
