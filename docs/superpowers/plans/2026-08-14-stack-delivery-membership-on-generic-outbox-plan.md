...
4. Keep unavailable-notice delivery identity private, include the membership epoch, and derive the exact current generation inside `discard_unavailable_approval_continuation`'s transaction.
