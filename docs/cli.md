...
Shell commands run with your full account access, and each one still waits for approval on this computer unless you have allowed commands without asking; see [Shell Commands](tools/desktop.md#shell-commands) before enabling them.
