...
- **Providers** — validates the API key each configured model will use, whether saved for that model, set in its config, or shared by its provider (Anthropic, OpenAI, Ollama, Vertex AI Claude, etc.)
