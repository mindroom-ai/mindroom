...
Print the exact cloud agent Matrix device identity that the local bridge must pin.

<!-- CODE:START -->
<!-- from mindroom.cli.main import app -->
<!-- from typer.testing import CliRunner -->
<!-- runner = CliRunner() -->
<!-- result = runner.invoke(app, ["desktop", "controller", "--help"]) -->
<!-- print("```") -->
<!-- print(result.output) -->
<!-- print("```") -->
<!-- CODE:END -->
...
```
 ...
 Usage: root desktop controller [OPTIONS]

 Print the cloud controller identity that the local bridge must pin.

╭─ Options ──────────────────────────────────────────────────────────────────────────────╮
│ *  --entity                TEXT  Cloud agent whose Matrix device will send commands.   │
│                                  [required]                                            │
│    --config        -c      PATH  Cloud MindRoom config path.                           │
│    --storage-path  -s      PATH  Cloud MindRoom state directory.                       │
│    --help          -h            Show this message and exit.                           │
╰────────────────────────────────────────────────────────────────────────────────────────╯
