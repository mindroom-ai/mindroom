...
Per-agent workspace targets export a room only when its configured or sole persisted invite owner is in the target's source scope, because joined membership is an additional check rather than ownership authority.
