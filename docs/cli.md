...
Shell commands run with your full account access, and each one still waits for approval on this computer; see [Shell Commands](tools/desktop.md#shell-commands) before enabling them.
