...
With `include_requests=true`, the report adds reconciled provider-request token facts and request coverage as described in [Token Usage](../dashboard.md#token-usage); missing request detail remains unavailable.
