...
Because the runner shares the pod network, the charts generate a `MINDROOM_API_KEY` Secret for the primary when no other primary API authentication is configured.
