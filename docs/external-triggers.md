...
For background-agent completion, use [Agent Callbacks](agent-callbacks.md): one tool call creates a single-use capability trigger and a Bash/curl script that wakes the originating agent and thread.
