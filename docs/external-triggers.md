...
For background-agent completion, use [Agent Callbacks](agent-callbacks.md) instead: one tool call creates a single-use script that wakes the originating agent and thread.
