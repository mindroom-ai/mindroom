...
For Matrix-backed private agents, the trusted identity must also map to a Matrix user ID through either a configured Matrix user ID header or `MINDROOM_TRUSTED_UPSTREAM_EMAIL_TO_MATRIX_USER_ID_TEMPLATE`.
