...
| MAT-003 / rank 15: Matrix thread and visible-event helpers | In progress with Herschel the 5th (`019dfb4e-9d5e-7252-abe7-196f5167d6dd`) | Pending | `refactor/matrix-thread-visible-helpers` | Pending | Pending |
