...
| API-003 / rank 13: Credentials worker-target resolver | In progress with Hooke the 5th (`019dfb44-844f-7e30-9d39-4bb8435d5127`) | Pending | `refactor/credentials-worker-target` | Pending | Pending |
