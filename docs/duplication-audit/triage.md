...
| WORK-002 / rank 16: Worker lifecycle pure helpers | Revision requested; line gate not yet accepted | [#905](https://github.com/mindroom-ai/mindroom/pull/905) | `refactor/worker-lifecycle-helpers` | Current production net `+43` lines | Focused worker tests passed in worker report; awaiting smaller revision |
