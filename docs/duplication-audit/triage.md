...
| TOOL-001 / rank 17: Plugin import transaction cleanup | Revision requested; line gate not yet accepted | [#909](https://github.com/mindroom-ai/mindroom/pull/909) | `refactor/plugin-import-transactions` | Current production net `+30` lines | Focused plugin tests passed in worker report; awaiting smaller revision |
