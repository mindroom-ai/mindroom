...
| CORE-001 / rank 19: Streaming tool tracking | Revision requested; line gate not yet accepted | [#912](https://github.com/mindroom-ai/mindroom/pull/912) | `refactor/streaming-tool-tracker` | Current production net `+34` lines | Focused streaming and team tests passed locally; awaiting smaller revision |
