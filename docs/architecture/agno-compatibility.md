...
| `history/agno_compat_message_builder.py` | Roleful Team input and history-media message-builder bindings. | Agent/Team construction installs the patch; history owners strip ordinary historical media while retaining only bounded tool-produced images carrying MindRoom's private viewed-image marker. |
