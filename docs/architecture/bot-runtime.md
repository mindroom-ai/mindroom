...
Incomplete turn groups bypass ordinary age and count cleanup until terminal settlement so their response intents and execution journals cannot expire while a dispatch obligation still owns recovery.
