...
The homeserver repeats an unacted-on invite in sync responses, while a separate pending-invite record stores the room and inviter so the configured invitation policy can reconsider unfinished work.
