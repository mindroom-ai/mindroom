...
The [Agno compatibility inventory](agno-compatibility.md) covers the full runtime; the table below describes the history-related boundaries and the shared tool-hook patch.
