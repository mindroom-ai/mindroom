...
- Agents respond with thread relations. In non-thread clients, send plain
  replies and verify they stay plain replies unless the incoming event carries
  explicit `m.thread` metadata.
