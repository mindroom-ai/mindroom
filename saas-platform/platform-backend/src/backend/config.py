...
INSTANCE_TRUSTED_UPSTREAM_EMAIL_DOMAIN = os.getenv("INSTANCE_TRUSTED_UPSTREAM_EMAIL_DOMAIN", "")
...
# First-party OIDC issuer used by hosted Synapse instances for Matrix SSO.
MATRIX_OIDC_ENABLED = os.getenv("MATRIX_OIDC_ENABLED", "false").lower() in {"1", "true", "yes"}
MATRIX_OIDC_ISSUER = os.getenv("MATRIX_OIDC_ISSUER", "")
MATRIX_OIDC_CLIENT_ID = os.getenv("MATRIX_OIDC_CLIENT_ID", "mindroom-synapse")
MATRIX_OIDC_CLIENT_SECRET = _get_secret("MATRIX_OIDC_CLIENT_SECRET", "")
MATRIX_OIDC_PRIVATE_KEY = _get_secret("MATRIX_OIDC_PRIVATE_KEY", "")
MATRIX_OIDC_KEY_ID = os.getenv("MATRIX_OIDC_KEY_ID", "mindroom-platform")

INSTANCE_MATRIX_OIDC_ENABLED = os.getenv("INSTANCE_MATRIX_OIDC_ENABLED", "")
INSTANCE_MATRIX_OIDC_ISSUER = os.getenv("INSTANCE_MATRIX_OIDC_ISSUER", "")
INSTANCE_MATRIX_OIDC_CLIENT_ID = os.getenv("INSTANCE_MATRIX_OIDC_CLIENT_ID", "")
INSTANCE_MATRIX_OIDC_CLIENT_SECRET = _get_secret("INSTANCE_MATRIX_OIDC_CLIENT_SECRET", "")
