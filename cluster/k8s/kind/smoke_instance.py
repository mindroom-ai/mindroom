    ...
    *,
    ...
    run_command(
        [
            ...
            # No accountId: without Supabase credentials this smoke instance has no hosted auth,
            # and the chart refuses to render a hosted-looking instance that nothing authenticates.
            "--set",
