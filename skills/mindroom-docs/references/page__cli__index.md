...
│                                      [default: 2000]                                   │
│ --prefer-cache                       Serve thread bodies from the durable event cache  │
│                                      and only fetch from the homeserver on miss or     │
│                                      invalidation. Use alongside a running MindRoom    │
