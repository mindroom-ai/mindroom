...
2. The file watcher never bypasses that drain; `ConfigReloadLifecycle.force_reload()` is an explicit operator escape hatch that may interrupt active responses
