...
The homeserver repeats an unacted-on invite in sync responses, and MindRoom separately stores the pending room and inviter for invitation-policy recovery.
