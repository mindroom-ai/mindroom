...
The default `matrix_sync.mode: sliding` streams events through MSC4186 Simplified Sliding Sync.
Set `matrix_sync.mode: classic` to use classic `/v3/sync` instead.
