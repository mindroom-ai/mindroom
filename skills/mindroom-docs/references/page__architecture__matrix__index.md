...
After a live room join or restart with server-reported joined rooms, decryption-failure callbacks for that room stay fenced until a trusted sync response confirms joined membership.
