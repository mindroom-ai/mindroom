...
defaults:
  ...
  max_tool_calls_per_turn: 500     # Default: 500 (tool calls one agent or team turn may execute; later calls return a tool error, and the turn ends with its text so far after this many plus two model requests)
