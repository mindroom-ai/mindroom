...
Restart MindRoom after changing this option.
...
See [Background jobs](https://docs.mindroom.chat/tools/agent-orchestration/#background-jobs) for the complete waiting and result behavior.
