...
- `agents.<name>.context_files` inject workspace-relative file context at agent creation/reload (see [Agents](https://docs.mindroom.chat/configuration/agents/index.md))
