...
| `MINDROOM_SCRIPT_RETENTION_SECONDS` | Finite positive seconds to retain terminal background-script runs, tool-call receipts, approval rows, and private snapshots before lifecycle pruning | `2592000` (30 days) |
