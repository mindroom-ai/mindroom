...
MindRoom omits those instructions when every function is deferred because native tool search cannot extend the already-sent system prompt when it discovers a tool.
