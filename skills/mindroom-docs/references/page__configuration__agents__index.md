...
The manual [`threads export`](https://docs.mindroom.chat/cli/#threads-export) command keeps its conservative zero-room guard because its persisted source state may be incomplete.
