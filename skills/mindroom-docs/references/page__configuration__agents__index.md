...
| `knowledge_bases` | list | `[]` | Knowledge base IDs from top-level `knowledge_bases`. Semantic bases add indexed RAG search. File-mode bases expose workspace file paths for agents with file-aware tools |
