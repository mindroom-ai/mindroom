...
- See [Matrix Message Full Semantics](https://docs.mindroom.chat/tools/matrix-message/) for the complete long-form method reference relocated from the model-facing description.
