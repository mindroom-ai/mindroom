...
Realistic chat and tool content typically sits 3-4x below the bound, the compaction budget's reserve and safety margin absorb such pockets, and an oversized request recovers through the existing shrink-retry path.
