...
See [Trusted Upstream Browser Auth](https://docs.mindroom.chat/deployment/trusted-upstream-auth/) for the provider-neutral authentication boundary.
...
- See the [origin-room report threat model](https://docs.mindroom.chat/dev/2026-07-23-origin-room-report-threat-model/) for prevented, bounded, and out-of-scope risks.
