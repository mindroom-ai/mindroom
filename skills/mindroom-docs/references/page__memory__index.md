...
For all-file teams, team file memory is mirrored under each participating agent's storage directory. For mixed teams, it is written only under file-backed members' storage directories while the scope ID still names the full team:
