...
- [Matrix & Attachments](https://docs.mindroom.chat/tools/matrix-and-attachments/index.md) - Matrix-native messaging, thread resolution, and attachment-aware workflows.
