...
All configuration fields, defaults and bounds are listed in the [agent configuration reference](https://docs.mindroom.chat/configuration/agents/#automatic-skill-learning).
