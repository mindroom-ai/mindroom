...
3. **AI sees it**: The model receives persisted items in the current user message and all `persist=False` items in one separate non-persisted user-context message immediately before it.
