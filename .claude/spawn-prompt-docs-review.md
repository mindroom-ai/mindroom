Perform a comprehensive documentation review for the MindRoom project. Follow the process described below exactly.
...
### 7. Self-Check the Prompt

The prompt file `.prompts/docs-review.md` can become outdated too. If you notice:
- New automated checks that should be listed above
- New doc files that need review guidelines
- Patterns that caused issues

Include prompt updates in your findings.

## Output Format

Write your findings to `.claude/REPORT.md`. Categorize findings:
...
Do NOT make any code or documentation edits yourself. Only produce the report. Write the full report to `.claude/REPORT.md`.
