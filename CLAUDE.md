...
| Google (Gemini API) | Fast / cheap text | Gemini 2.5 Flash-Lite Preview | `gemini-2.5-flash-lite-preview-09-2025` |
| Google (Gemini API) | Strongest text / coding | Gemini 3 Pro Preview | `gemini-3-pro-preview` |
| Google (Gemini API) | Image generation / editing | Nano Banana 2 | `gemini-3.1-flash-image-preview` |
| Google (Gemini API) | Embeddings for `google` | Gemini Embedding 001 | `gemini-embedding-001` |
...
Current Vertex AI image docs support `gemini-3.1-flash-image-preview`, `gemini-3-pro-image-preview`, and `gemini-2.5-flash-image`, and the right default depends on the specific Vertex surface you are editing.
For Google image work, use the official product name from the docs for the provider surface you are editing.
Gemini API docs call `gemini-3.1-flash-image-preview` Nano Banana 2, while Vertex AI docs usually present the same model as Gemini 3.1 Flash Image Preview.
