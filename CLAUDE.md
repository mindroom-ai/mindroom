...
| Google (Gemini API) | Max intelligence | Gemini 3 Pro Preview | `gemini-3-pro-preview` |
...
Use `gemini-3-pro-preview` only when you need the highest Gemini API intelligence tier and accept a preview model.
