...
| `restart_recovery.py` | Central restart-recovery coordinator with semantic retries, bounded room I/O, exact-generation fencing, and idempotent resume delivery |
