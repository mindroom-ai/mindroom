...
| `mid_turn_judgment.py` | Bind the active request and room settings to the shared LLM or TypeSafe judgment backend |
| `config/mid_turn.py` | Opt-in room settings for the mid-turn judgment backend and decision instructions |
