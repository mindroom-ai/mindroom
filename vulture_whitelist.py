...
_.validate_agent_participation  # Pydantic model validator (src/mindroom/config/main.py)
_.validate_room_mid_turn  # Pydantic model validator (src/mindroom/config/main.py)
