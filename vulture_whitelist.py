...
_.invalidate_outbound_session  # matrix-nio crypto callback override (src/mindroom/matrix/client_session.py)
_._handle_joined_members  # matrix-nio response-handler override (src/mindroom/matrix/client_session.py)
_._handle_olm_events  # matrix-nio sync-handler override (src/mindroom/matrix/client_session.py)
