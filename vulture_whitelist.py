...
_.close_connection  # unused attribute (src/mindroom/egress/agent_vault_bridge.py)
...
_.do_HEAD  # unused method (src/mindroom/egress/agent_vault_bridge.py)
_.do_OPTIONS  # unused method (src/mindroom/egress/agent_vault_bridge.py)
_.do_PATCH  # unused method (src/mindroom/egress/agent_vault_bridge.py)
_.do_POST  # unused method (src/mindroom/egress/agent_vault_bridge.py)
_.do_PUT  # unused method (src/mindroom/egress/agent_vault_bridge.py)
...
_.validate_worker_egress_broker_references  # unused method (src/mindroom/config/main.py)
...
agent_vault_vault_name  # unused method (src/mindroom/workers/backends/kubernetes_resources.py)
