...
ThreadExportTarget  # plugin-facing API class (src/mindroom/thread_export.py)
export_threads_to_targets_once  # plugin-facing API function (src/mindroom/thread_export.py)
_export_threads_for_client  # focused test seam (src/mindroom/thread_export.py)
