...
_.validate_agent_repository_assignments  # Pydantic model validator (src/mindroom/config/main.py)
_.validate_organization  # Pydantic field validator (src/mindroom/config/agent_repository.py)
