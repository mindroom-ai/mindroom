...
__getattr__  # lazy PEP 562 re-exports (src/mindroom/history/__init__.py)
MindroomVertexAIClaude  # loaded via _PROVIDER_MODEL_CLASS_PATHS (src/mindroom/model_loading.py)
